 ...
 * @since  12.1
 */
abstract class F0FDatabaseDriverPdo extends F0FDatabaseDriver
{
	/**
	...
	public function execute()
	{
		...
		{
			// Bind the variables:
			if ($this->sql instanceof F0FDatabaseQueryPreparable)
			{
	...
	public function setQuery($query, $offset = null, $limit = null, $driverOptions = array())
	{
		...
		if ($query instanceof F0FDatabaseQueryLimitable && !is_null($offset) && !is_null($limit))
		{
		...
		// Store reference to the original F0FDatabaseQuery instance within the class.
