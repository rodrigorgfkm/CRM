<?php /* C:\xampp\htdocs\cnc\administrator\components\com_akeeba\ViewTemplates\Backup\default.blade.php */ ?>
<?php
/**
...
<div id="backup-setup" class="akeeba-panel--primary">
	...
	<form action="index.php" method="post" name="flipForm" id="flipForm"
        ...
        <div class="akeeba-form-group">
	        ...
	        <?php echo \JHtml::_('select.genericlist', $this->profileList, 'profileid', ['list.select' => $this->profileId, 'id' => 'comAkeebaBackupProfileDropdown', 'list.attr' => ['class' => 'advancedSelect']]); ?>
        </div>
