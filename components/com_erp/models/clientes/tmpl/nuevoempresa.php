                ...
                <div class="main_content">
                    ...
                    <div class="row-fluid">
						<div class="span12">
                              ...
                              <table class="table table-striped table-bordered dataTable">
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                    	<input type="text" name="empresa" id="empresa" onKeyUp="buscaCliente()">
                            ...
                            <? }else{
                                newCliente();?>
                                <h3>La empresa fue creada correctamente</h3>
                                <p><input type="button" name="button" value="Volver" onClick="location.href='index.php?option=com_erp&view=clientes&layout=empresa'"></p>
                                <?
                                }?>
