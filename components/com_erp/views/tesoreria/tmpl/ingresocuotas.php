  ...
  <section class="col-lg-12 ">
    <div class="box box-success">
      <div class="box-header">
		...
		<!-- Título de la vista -->
        <h3 class="box-title">Ingresos por Cuotas</h3>
      </div>
      <div class="box-body">
        <div class="col-xs-12">
          <form action="" method="post" class="vfiltro" style="margin:0px;">
            ...
            <a class="btn btn-warning" href="index.php?option=com_erp&view=tesoreria&layout=ingresocuotas"><em class="icon-exclamation-sign icon-white"></em> Limpiar</a>
          </form> 
        </div>
      </div>
