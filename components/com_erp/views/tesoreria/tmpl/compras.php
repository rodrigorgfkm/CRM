...
function exportaLC(t){
	if(t == 1)
		...
		//jQuery('#export').attr('action', 'index.php?option=com_erp&view=facturacion&layout=exportar_txt&tmpl=blank');
		else
        ...
        <div class="row-fluid">
          <div class="col-xs-12">
              <form action="" method="post">
                ...
                <span class="col-xs-12 col-sm-4">
                    ...
                    <div class="col-xs-12">
                        Desde: <input type="text" id="fecha_ini" disabled name="fecha_ini" class="form-control" value="<?=JRequest::getVar('fecha_ini', '', 'post')?>" style="display: inline-block;">
                        Hasta: <input type="text" id="fecha_fin" disabled name="fecha_fin" class="form-control" value="<?=JRequest::getVar('fecha_fin', '', 'post')?>" style="display: inline-block; margin-left: 2px;">
                    </div>
                </span>
          ...
          <div class="span3" style="text-align:right">
            <form action="components/com_erp/views/facturacion/tmpl/exportar.php" id="export" method="post">
              <button class="btn btn-success exel" type="submit">Exportar a Excel</button>
              <button class="btn btn-info" onClick="exportaLC_(1)">Exportar a Facilito</button>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a data-toggle="modal" data-backdrop="static" href="#elimina" onClick="jQuery('#btn_confirma').attr('href', 'index.php?option=com_erp&view=tesoreriareporte&layout=compraelimina&id=<?=$factura->id?>')" class="btn btn-danger ttip_t" title="Eliminar compra"><em class="fa fa-trash"></em></a>
                </td>
            </tr>
            <? }?>
        </tbody>
