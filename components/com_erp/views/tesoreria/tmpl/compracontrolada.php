  ...
  <section class="col-lg-12">
    <div class="box box-success">
      <div class="box-header">
		...
		<!-- Título de la vista -->
        <h3 class="box-title">Procesos Compras controladas</h3>
      <div class="box-body">
        <div class="row-fluid">
          <div class="col-xs-12">
              <form action="" method="post">
                ...
                <input type="text" name="filtro" class="form-control" value="<?=JRequest::getVar('filtro', '', 'post')?>">
                     <select name="mes" id="mes" class="form-control" <?=JRequest::getVar('rango','','post')=='1'?'disabled':'';?>>
                    ...
                    <select name="anio" id="anio" class="form-control" <?=JRequest::getVar('rango','','post')=='1'?'disabled':'';?>>
                ...
                <span class="col-xs-12 col-sm-4">
                    <label style="display: inline"><input type="checkbox" onClick="rangoFecha()" name="rango" id="rango" <?=JRequest::getVar('rango','','post')=='1'?'checked':''?> value="1" style="display: inline"> Elegir rango de fechas: </label> <br>
                    <div class="col-xs-12">
                        Desde: <input type="text" id="fecha_ini" <?=JRequest::getVar('rango','','post')=='1'?'':'disabled';?> name="fecha_ini" class="form-control datepicker" value="<?=JRequest::getVar('fecha_ini', '', 'post')?>" style="display: inline-block;">
                        Hasta: <input type="text" id="fecha_fin" <?=JRequest::getVar('rango','','post')=='1'?'':'disabled';?> name="fecha_fin" class="form-control datepicker" value="<?=JRequest::getVar('fecha_fin', '', 'post')?>" style="display: inline-block; margin-left: 2px;">
                    </div>
                </span>
    ...
    <table class="table table-bordered table-striped table_vam" id="tabladinamica">
        <thead>
            <tr>
                ...
                <th width="225">Producto o Servicio</th>
        ...
        <tbody>
            ...
            $total = 0;
            $totalcf = 0;
            foreach(getCompras(1) as $factura){
