        ...
        <div class="row filtros-tablas">
          <div class="col-md-8">
              <form action="" method="post" style="width:100%; margin-bottom: 30px;">                
                    ...
                    <div class="junto">
                        ...
                        <div class="junto" >
                            Desde
                            <input type="text" disabled id="fecha_ini" class="form-control datepicker" name="fecha_ini" value="<?=JRequest::getVar('fecha_ini', '', 'post')?>" style="margin-left: 5px;">
                            <span class="" style="padding-left:7px;"></span>
                            Hasta
                            <input type="text" disabled id="fecha_fin" class="form-control datepicker" name="fecha_fin" value="<?=JRequest::getVar('fecha_fin', '', 'post')?>" style="margin-left: 5px;">
          ...
          <div class="col-md-4">
            <form action="components/com_erp/views/facturacion/tmpl/exportar_ventas.php" id="export" method="post">
              <a  data-toggle="modal" data-target=".borratiposoc" href="#excel_" class="btn btn-success pull-right xcel_">Exportar a Excel</a>
              <button class="btn btn-info pull-right" type="button" onClick="exporta_LC(1)">Exportar a Facilito</button>
