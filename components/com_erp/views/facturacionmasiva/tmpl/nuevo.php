  ...
  <section class="col-lg-12">
    <div class="box box-success">
	  ...
	  if(getIdSucursalUsuarioF()){
        ...
        <form action="index.php?option=com_erp&view=facturacionmasiva&layout=generafactura&tmpl=component&id_suc=<?=JRequest::getVar('id_suc', '', 'get')?>" method="post" enctype="multipart/form-data" name="form" id="form"  class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-3">                   
              <input type="text" name="fecha_pago" id="fecha_pago" class="form-control datepicker validate[requried]" value="<?=date('d/m/Y')?>">
            </div>
          </div>
          <!--<div class="form-group">
            <label for="" class="col-xs-12 col-sm-2">
