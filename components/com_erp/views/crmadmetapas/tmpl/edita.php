  ...
  <section class="col-lg-12">
    <div class="box box-success">
      ...
      <div class="col-xs-12 text-right">
          <div class="btn-group">
               <a href="index.php?option=com_erp&view=crmadmetapas" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Volver</a>
          </div>          
      </div>
      <div class="box-body">
       <!--Nueva Etapa-->
        <form action="" name="form" id="form" class="form-horizontal" method="post" role="form">
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-10">
                    <input type="text" name="etapa" id="etapa" class="form-control validate[required]" value="<?=$e_etapa->etapa?>">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-xs-12 col-sm-2 control-label">
                ...
                <div class="col-xs-12 col-sm-10">
                    <input type="number" name="orden" id="orden" class="form-control validate[required]" value="<?=$e_etapa->orden?>">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-xs-12 col-sm-2 control-label">
                ...
                <div class="col-xs-12 col-sm-10">
                    <div class="dropdown">
                      ...
                      <input type="hidden" name="color" id="color" value="<?=$e_etapa->color?>">
                      <div class="recuadro-color" <?=$e_etapa->color?> id="result-color"></div>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-10">
                    <div class="input-group">
                      <div class="input-group-addon"><i class="fa <?=$e_etapa->icono?>"></i></div>
                      <input type="text" name="icono" id="icono" class="form-control validate[required]" readonly placeholder="Click aqui para agregar un Icono" value="<?=$e_etapa->icono?>">
                    </div>                    
                </div>
            </div>
        ...
        <? }else{
            editCRMEtapas();
        ?>
            <h5 class="alert alert-success">Se ha editado correctamente esta etapa</h5>
            <a href="index.php?option=com_erp&view=crmadmetapas" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Volver al Listado</a>
        <? }?>
      </div>
    </div>
  </section>
</div>
<? require_once ('components/com_erp/views/crmadmetapas/tmpl/iconos.php');?>
<? }else{vistaBloqueada();}?>