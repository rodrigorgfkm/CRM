...
$stats = getCRMfechaDia($desde, $hasta, $id);
?>
...
AmCharts.ready(function () {
    ...
    valueAxis.title = "Negocios en Proceso";
  ...
  <section class="col-lg-12">
    <div class="box box-success">
      ...
      <div class="box-body">
          ...
          <form action="" name="form-control" id="form" class="form-horizontal" method="post">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <a href="index.php?option=com_erp&view=crmestadisticas&layout=enproceso&id=<?=$id?>" class="btn btn-info"><i class="fa fa-eraser"></i> Limpiar</a>
                        <a href="index.php?option=com_erp&view=crmvendedor&layout=listadoenproceso" class="btn bg-orange pull-right"><i class="fa fa-arrow-left"></i> Volver al Listado</a>
                    </div>
                </div>
            </form>
        <? if($contador!=0){?>    
        ...
        <? }else{?>
                <div class="alert alert-info"><i class="fa fa-exclamation-circle"></i> No existen Resultados Estadisticos en éste Mes</div>
                <!--<div class="col-xs-12"><a href="index.php?option=com_erp&view=crmvendedor&layout=listadoenproceso" class="btn bg-orange pull-right"><i class="fa fa-arrow-left"></i> Volver al Listado</a></div>-->
        <? }?>
          <!--<div id="mostrar"></div>-->
      </div>
    </div>
