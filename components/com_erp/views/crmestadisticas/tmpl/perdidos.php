...
var chart = AmCharts.makeChart("chartdiv", {
    ...
    "dataProvider": [
        <?
        $c=0;
        foreach (getCRMestadoFinal(2, $desde, $hasta) as $perdidos){            
            if($c!=0){
                echo ',';
            }
            echo "{";            
  ...
  <section class="col-lg-12">
    <div class="box box-success">
      <div class="box-header">
		...
		<!-- Título de la vista -->
        <h3 class="box-title">Estadisticas De Prospectos Perdidos</h3>
      </div>
            ...
            <form action="" name="form-control" id="form" class="form-horizontal" method="post">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <a href="index.php?option=com_erp&view=crmestadisticas&layout=perdidos" class="btn btn-info"><i class="fa fa-eraser"></i> Limpiar</a>
                    </div>
                </div>
            </form>        
        <? if(count(getCRMestadoFinal(2, $mes, $anio))>0){?>
