...
var chart = AmCharts.makeChart("chartdiv", {
    ...
    "dataProvider": [
        <?
        $c=0;
        foreach (getCRMestadoFinal(2, $desde, $hasta,$id) as $perdidos){            
            if($c!=0){
                echo ',';
            }
            echo "{";            
            echo '"Perdidos": "'.$perdidos->cant_estado.'",';
            echo '"Fecha_Cierre": "'.$perdidos->fecha_cierre.'",';
            echo '"color": "#FF0F00"';
            echo "}";
            $c++;
        }            
  ...
  <section class="col-lg-12">
    <div class="box box-success">
      <div class="box-header">
		...
		<!-- Título de la vista -->
        <h3 class="box-title">Estadisticas de clientes perdidos</h3>
      </div>
      <div class="box-body">
            ...
            <form action="" name="form-control" id="form" class="form-horizontal" method="post">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <a href="index.php?option=com_erp&view=crmestadisticas&layout=clientesperdidos&id=<?=$id?>" class="btn btn-info"><i class="fa fa-eraser"></i> Limpiar</a>
                        <a href="index.php?option=com_erp&view=crmestadisticas&layout=listadoperdidos" class="btn bg-orange pull-right"><i class="fa fa-arrow-left"></i> Volver al Listado</a>
                    </div>
                </div>
            </form>
        ...
        <? }else{?>
                ...
                <div class="col-xs-12"><a href="index.php?option=com_erp&view=crmestadisticas&layout=listadoperdidos" class="btn bg-orange pull-right"><i class="fa fa-arrow-left"></i> Volver al Listado</a></div>
            <? }?>
      </div>
    </div>
  </section>
