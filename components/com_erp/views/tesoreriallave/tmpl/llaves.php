            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="index.php?option=com_erp&view=tesoreriallave&layout=llaveelimina&id=<?=$llave->id?>" data-toggle="tooltip" title="Eliminar llave" class="btn col-xs-12 btn-danger"><i class="fa fa-trash"></i></a>
                        <? }?>
                    </td>
                </tr>
                <? }?>
