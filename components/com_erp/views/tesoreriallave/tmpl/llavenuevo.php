            ...
            <form method="post" enctype="multipart/form-data" name="form" id="form" class="form-horizontal" role="form">
              <div class="form-group">
                  ...
                  <div class="col-xs-12 col-sm-10">
                      <input type="text" name="autorizacion" id="autorizacion" class="form-control validate[required, maxSize[<?=$lim_auto?>]]">
                  </div>
              </div>
              <div class="form-group">
                  <label for="" class="col-xs-12 col-sm-2 control-label">
                  ...
                  <div class="col-xs-12 col-sm-10">
                      <input type="text" name="llave" id="llave" class="form-control llave validate[require, maxSize[<?=$lim_LLave?>]]">
                  </div>
              </div>
              <div class="form-group">
                  <label for="" class="col-xs-12 col-sm-2 control-label">
              ...
              <div class="form-group">
                  <label for="" class="col-xs-12 col-sm-2 control-label">
                      Número <i class="fa fa-asterisk text-red"></i>
                  </label>
                  <div class="col-xs-12 col-sm-10">
                      <input type="text" name="numero" id="numero" class="form-control validate[required]" value="">
                  </div>
              </div>
              <div class="form-group">
                  <label for="" class="col-xs-12 col-sm-2 control-label">
              ...
              <div class="form-group">
                  ...
                  <div class="col-xs-12 col-sm-10">                      
                      <input type="text" name="leyenda" id="leyenda" class="form-control validate[required]">
                  </div>
              </div>
              ...
              <table class="table table-striped table-bordered dataTable">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <?=JRequest::getVar('fecha_limite', '', 'post')?>
                        <input type="hidden" name="fecha_limite" id="fecha_limite" value="<?=JRequest::getVar('fecha_limite', '', 'post')?>">
                    </td>
                  </tr>
                  <tr>
                    <td>Sucursal</td>
                  ...
                  <tr>
                    ...
                    <td>
                        <?
                        $leyenda =  JRequest::getVar('leyenda','','post');
                        echo $leyenda;
                        ?>
                        <input type="hidden" name="leyenda" id="leyenda" value="<?=$leyenda?>">
                    </td>
                  </tr>
                  <tr>
                    <td>Número</td>
                ...
                <a href="index.php?option=com_erp&view=tesoreriallave&layout=llaves" class="btn btn-success">Volver</a>
                <? }?>
      </div>
    </div>
  </section>
