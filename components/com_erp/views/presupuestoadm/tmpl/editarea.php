  ...
  <section class="col-lg-12">
    <div class="box box-success">
        <div class="box-header">
            ...
            <!-- Título de la vista -->
        <h3 class="box-title">Editar Área de Presupuesto</h3>        
        </div>
        <div class="box-body">
        ...
        <div class="box-body">
            ...
            <form action="" name="form" id="form" class="form-horizontal" method="post">
                <div class="form-group">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Código de la Cuenta" value="<?=codigoRename($reg->codigo)?>">
                            <input type="text" name="area" id="area" class="form-control" readonly value="<?=$reg->area?>">
                            <input type="hidden" name="ic_cta" id="ic_cta" value="<?=$reg->id?>">
            ...
            <? }else{
                editAreaPresupuesto();
            ?>
                <h3 class="alert alert-success">Se ha Editado correctamente el área de presupuesto</h3>
            <? }?>
        </div>
    </div>
  </section>
