...
<div class="row">
  <section class="col-lg-12">
    <div class="box box-success">
        ...
        <h4 class="text-center">REPORTE RESUMEN DEL PRESUPUESTO DEL MES<br>Gestión: <?=$mesact?> <?=date('Y')?><br><span style="display:<?=$moneda==1?'none':'block'?>">(Expresado en Dólares Americanos)</span></h4>
            	...
            	<form method="post" enctype="multipart/form-data" name="form" id="form" class="form-horizontal" role="form">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        ...
                        <select name="cuent" id="cuent" class="form-control" style="width:auto; display:inline">
                            ...
                            <option value='3__002' <?=$cuentas=='3__002'?'selected':'';?>>3.XX0020000</option>
                            <option value='3__003' <?=$cuentas=='3__003'?'selected':'';?>>3.XX0030000</option>
                            <option value='4__001' <?=$cuentas=='4__001'?'selected':'';?>>4.XX0010000</option>
                            <option value='4__002' <?=$cuentas=='4__002'?'selected':'';?>>4.XX0020000</option>
                            <option value='4__003' <?=$cuentas=='4__003'?'selected':'';?>>4.XX0030000</option>
                            <option value='4__004' <?=$cuentas=='4__004'?'selected':'';?>>4.XX0040000</option>
                            <option value='4__005' <?=$cuentas=='4__005'?'selected':'';?>>4.XX0050000</option>
                            <option value='4__007' <?=$cuentas=='4__007'?'selected':'';?>>4.XX0070000</option>
