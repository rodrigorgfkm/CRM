  ...
  <section class="col-lg-12">
    <div class="box box-success">
      <div class="box-header">
		...
		<!-- Título de la vista -->
        <h3 class="box-title">Historiald e modificaciones</h3>
        ...
        <table class="table table-bordered table-striped table_vam datatable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" data-toggle="tooltip" title="Ver detalle completo del registro" class="btn btn-info" ><i class="fa fa-eye"></i> Ver registro</a>
                    </td>
                </tr>
                <? }?>
            </tbody>
