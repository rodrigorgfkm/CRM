...
if(validaAcceso('Crea Cargo Clientes')){
    ...
    $lim_cargo = 20;
            ...
            <form method="post" enctype="multipart/form-data" name="form" id="form" class="form-horizontal">
              <div class="box-body">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="cargo" id="cargo" placeholder="Introduzca un cargo" class="form-control validate[required, maxSize[<?=$lim_cargo?>]]">
                  </div>
                </div>
              </div>
            ...
            <? }else{
                    newCargo();?>
                    <h3>El cargo fue creado correctamente</h3>
                    <p>
