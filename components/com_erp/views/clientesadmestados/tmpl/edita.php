...
$estado = getClienteEstado(JRequest::getVar('id','','get'));
?>
<div class="row">
        ...
        if(!$_POST){?>
           <form method="post" enctype="multipart/form-data" name="form" id="form" class="form-horizontal">
              <div class="box-body">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="estado" id="estado" class="form-control validate[required, maxSize[<?=$lim_est?>]]" value="<?=$estado->estado?>">
                  </div>
                </div>
              </div>
              <div class="box-footer">
                <a href="index.php?option=com_erp&view=clientesadmestados" class="btn btn-info">
