...
<div class="row">
  <section class="col-lg-12">
    <div class="box box-success">
      ...
      <div class="col-xs-12">
          <a href="index.php?option=com_erp&view=clientesadmestados&layout=nuevo" class="btn btn-primary pull-right" style="margin-bottom:5px"><i class="fa fa-plus"></i> Crear Estados</a>
      </div>
      <div class="box-body">
                ...
                <tbody>
                   <? foreach (getClienteEstados()  as $estado){?>
                    <tr>
                        <td><?=$estado->estado?></td>
                        <td>
                            <a href="index.php?option=com_erp&view=clientesadmestados&layout=edita&id=<?=$estado->id?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                            <button type="button" class="btn btn-danger btn-delete" data-toggle="modal" data-target=".borratiposoc" data-id="<?=$estado->id?>"><i class="fa fa-trash"></i></button>
                        </td>
                    </tr>
                    <? }?>
                </tbody>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel">¿Eliminar Éste Estado?</h4>
                      ...
                      <div class="modal-body">
                          <form action="" name="form" id="form" class="form-horizontal col-xs-12" role="form" method="get">
                            <div class="col-xs-12 text-right">
                                ...
                                <input type="hidden" name="view" value="clientesadmestados">
