  ...
  <section class="col-lg-12">
    <div class="box box-success">
      ...
      <div class="col-xs-12 text-right">
          <div class="btn-group">
               <a href="index.php?option=com_erp&view=facturacioncobranzas" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Volver</a>
          </div>          
      </div>
      <div class="box-body">
       <!--Nueva Etapa-->
        <form action="" name="form" id="form" class="form-horizontal" method="post" role="form">
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-10">
                    <input type="text" name="modo_envio" id="modo_envio" class="form-control validate[required]" value="<?=$envio->modo_envio?>">
                </div>
            </div>
        ...
        ?>
                ...
                <a href="index.php?option=com_erp&view=facturacioncobranzas" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Volver al Listado</a>
        <? }?>
      </div>
    </div>
  </section>
