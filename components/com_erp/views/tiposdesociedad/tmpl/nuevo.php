          ...
          <? if(!$_POST){?>
           <form method="post" enctype="multipart/form-data" name="form" id="form" class="form-horizontal">
              ...
              <div class="box-body">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="sigla" id="sigla" class="form-control validate[required]">
                  </div>
                </div>
              </div>
            ...
            <p><a href="index.php?option=com_erp&view=tiposdesociedad" class="btn btn-primary"><em class="fa fa-arrow-left"></em> Ir al listado de sociedades</a></p>
            <? }?>
      </div>
    </div>
  </section>
