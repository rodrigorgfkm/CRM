...
function cargaVehiculoProforma(){
	jQuery('#marca').val('<?=$cabecera->vehiculo?>:<?=$cabecera->chasis?>');
	cargaChasis();
	}
</script>
<div class="row">
        ...
        <? if(!$_POST){?>
         <form method="post" enctype="multipart/form-data" name="form" id="form" class="form-horizontal">
              ...
              <table class="table table-striped table-bordered datatable" id="detalle_lista">
                ...
                <tfoot>
                  ...
                  <tr>
                    ...
                    <td><input name="descuento" type="text" class="form-control" id="descuento" value="0" onkeyup="calculatotal()" /></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
                    <td><strong>Total Bs.</strong></td>
                    <td><input name="grantotal" type="text" class="form-control" id="grantotal" value="<?=$total?>" readonly /></td>
                    <td>&nbsp;</td>
                  </tr>                        
                </tfoot>
              </table>
          ...
          <div class="col-xs-12 col-sm-offset-2">
              ...
              <button class="btn btn-success col-xs-6 col-sm-3" type="submit"><i class="fa fa-check"></i> Crear Nota <sapn class="hidden-xs">de entrega</sapn></button>
          </div>
        </form>
    <script>
    n = <?=$n?>;
        ...
        <tfoot>
          ...
          <tr>
            <td colspan="6" style="text-align:center">
              <a class="btn btn-info col-xs-12" rel="shadowbox" id="imprime" style="font-size:14px" href="index.php?option=com_erp&view=productosnotas&layout=imprime&id=<?=$id?>&tmpl=component">Imprimir</a>
            </td>
          </tr>
        </tfoot>
      </table>
