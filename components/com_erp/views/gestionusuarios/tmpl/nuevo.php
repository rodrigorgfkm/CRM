        ...
        <form class="form-horizontal" enctype="multipart/form-data" method="post" name="form" id="form" role="form">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <label style="display:inline"><input style="display:inline" type="radio" id="su_1" name="admin" value="1" onClick="superUsuario()" checked> Si</label>
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <label style="display:inline"><input style="display:inline" type="radio" id="su_1" name="admin" value="0" onClick="superUsuario()"> No</label>
              </div>
            </div>
