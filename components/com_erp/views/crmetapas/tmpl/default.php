...
<script>
    jQuery(document).on('ready',function(){
        ...
        jQuery('.habilita').on('click', function(){
            ...
            jQuery.ajax({
                url:"index.php?option=com_erp&view=crmetapas&layout=publicar&tmpl=blank",
                type: "POST",
  ...
  <section class="col-lg-12">
    <div class="box box-success">
      ...
      <div class="col-xs-12 text-right">
          <div class="btn-group">
               <a href="index.php?option=com_erp&view=crmetapas&layout=nuevo" class="btn btn-primary"><i class="fa fa-plus"></i> Crear Nuevo Estado</a>
          </div>          
      </div>
      <? }?>
      <div class="box-body">
                 ...
                 <? foreach (getCRMEtapas() as $etapapro){?>
                  <tr>
                      ...
                      <td>
                          ...
                          <a href="index.php?option=com_erp&view=crmetapas&layout=edita&id=<?=$etapapro->id?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> <span class="hidden-xs">Editar</span></a>
                          <? if(getCRMEtapasAct($etapapro->id)==0){?>
                            <a href="index.php?option=com_erp&view=crmetapas&layout=eliminar&id=<?=$etapapro->id?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> <span class="hidden-xs">Eliminar</span></a>
                          <? }?>
                      </td>
                  </tr>
                 <? }?>
