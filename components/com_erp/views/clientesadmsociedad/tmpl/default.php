  ...
  <section class="col-lg-12">
    <div class="box box-success">
      <div class="box-header">
		...
		<!-- Título de la vista -->
        <h3 class="box-title">Tipos de Sociedad</h3>
      </div>
      <div class="col-xs-12">
          <a href="index.php?option=com_erp&view=clientesadmsociedad&layout=nuevo" class="btn btn-primary pull-right" style="margin-bottom:5px"><i class="fa fa-plus"></i> Crear Tipo de Sociedad</a>
      </div>
      <div class="box-body">
                ...
                <tbody>
                   <? foreach (getTiposSociedad()  as $tipo){?>
                    <tr>
                        ...
                        <td><?=$tipo->sigla?></td>
                        <td>
                            <a href="index.php?option=com_erp&view=clientesadmsociedad&layout=edita&id=<?=$tipo->id?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                      ...
                      <div class="modal-body">
                          <form action="" name="form" id="form" class="form-horizontal col-xs-12" role="form" method="get">
                            <div class="col-xs-12 text-right">
                                ...
                                <input type="hidden" name="view" value="clientesadmsociedad">
