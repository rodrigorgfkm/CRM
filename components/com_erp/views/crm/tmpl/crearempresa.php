          ...
          <form action="index.php?option=com_erp&view=crm&layout=nuevaempresa" name="form" id="form" class="form-horizontal col-xs-12" role="form" enctype="multipart/form-data" method="post">
              ...
              <div class="oculto" id="contacto_0">
                  <div class="form-group">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="text" name="nombre_0" id="nombre_0" class="form-control validate[required, maxSize[<?=$lim_nom?>]]" placeholder="Nombre(s)">
                        <input type="text" name="apellido_0" id="apellido_0" class="form-control validate[required, maxSize[<?=$lim_ap?>]]" placeholder="Apellido(s)">
                      </div>
                  </div>
                  <div class="form-group">
                          <div class="col-md-6">
              ...
              <div class="form-group">
                  ...
                  <div class="progreso btn-group col-xs-12">
                      ...
                      ?> 
                          <button type="button" class="btn <?=$btn?> btn-lg <?=$ancho?> boton_estado" id="boton_<?=$num?>" data-idetapa="<?=$etapapro->id?>"><span class="hidden-xs"><?=$etapapro->etapa?></span></button>
                      <? $num++;
                          }?>
