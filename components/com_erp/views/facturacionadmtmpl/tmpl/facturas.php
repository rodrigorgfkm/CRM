        ...
        <table class="table table-bordered table-striped table_vam" id="tabladinamica">
            ...
            <tbody>
                ...
                <tr>                    
                    ...
                    <td>
                        <a href="index.php?option=com_erp&view=facturacionadmtmpl&layout=vistatmpl&id=<?=$plantilla->id?>&tmpl=component" class="btn btn-info" rel="shadowbox;width=800;"><i class="fa fa-eye"></i></a>
