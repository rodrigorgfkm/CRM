    ...
    <div class="box box-success">
      ...
      <div class="box-body">
          ...
          <? }else{
            ...
            <a href="index.php?option=com_erp&view=facturacionadmtmpl&layout=facturas" class="btn btn-info"><i class="fa fa-arrow-left"></i> Volver al listado de plantillas</a>
            <? }?>
      </div>
    </div>
  </section>
