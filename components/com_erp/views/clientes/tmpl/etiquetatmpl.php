...
@media print{
    ...
    .etiqueta{
        ...
        width: <?=$etiqueta->ancho.'px'?>;
        height: <?=$etiqueta->alto.'px'?>
    }
    .etiqueta>div{
        position: absolute;
        padding: 5px;
    ...
    <div class="box box-success">
      ...
      <div class="box-body">
        ...
        ?>
            ...
            <a href="index.php?option=com_erp&view=clientes&layout=etiquetas" class="btn btn-info"><i class="fa fa-arrow-left"></i> Regresar al Mantenimiento de Bancos</a>
        <? }?>
      </div>
    </div>
  </section>
