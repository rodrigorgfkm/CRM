        ...
        <table class="table table-bordered table-striped table_vam datatable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="index.php?option=com_erp&view=clientes&layout=historico&id=<?=$cliente->id?>" data-toggle="tooltip" title="Historial de registros" class="btn btn-info btn-block" ><i class="fa fa-history"></i> Historial de cambios</a>
                    </td>
                </tr>
                <? }
				}?>
