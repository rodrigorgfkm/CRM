    ...
    <div class="box box-success">
      ...
      <form method="post" enctype="multipart/form-data" name="form" id="form" class="form-horizontal" role="form">
      	<div class="box-body">
           <h4 class="text-primary">Registro de Asociado</h4>
                ...
                <div class="col-xs-12 col-md-4">
                    <? foreach (getClienteEstados($cliente->id) as $estado){
                        if($estado->id==$cliente->id_estado){?>
                            <input type="text" name="easoc" id="easoc" class="form-control" readonly value="<?=$estado->estado?>">
                        <? }
                    }?>
                </div>
                ...
                <div class="col-xs-12 col-md-4">                    
                    <select name="inscrito_por" id="inscrito_por" class="form-control validate[required]">
                        <? foreach(getUsuarios() as $usuario){
                            $selected = '';
                            if($cliente->id_usuario == $usuario->id){
                                $selected = 'selected';
                            }
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-md-4">
                    <input type="text" name="num_reg" id="num_reg" class="form-control validate[required,maxSize[<?=$lim_registro?>]]" placeholder="Número de Registro" value="<?=$cliente->registro?>" readonly>
                </div>                                     
                 <label for="" class="col-xs-12 col-md-2 control-label">
                    Libro
                </label>
                <div class="col-xs-12 col-md-4">
                    <input type="text" name="libro" id="libro" class="form-control validate[required,maxSize[<?=$lim_libro?>]]" placeholder="Libro" value="<?=$cliente->libro?>" readonly>
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-xs-12 col-md-2 control-label">
                ...
                <div class="col-xs-12 col-md-4">
                    <input type="text" name="tomo" id="tomo" class="form-control validate[required,maxSize[<?=$lim_tomo?>]]" placeholder="Tomo" value="<?=$cliente->tomo?>" readonly>
                </div>
                <label for="" class="col-xs-12 col-md-2 control-label">
                    Partida
                </label>
                <div class="col-xs-12 col-md-4">
                    <input type="text" name="partida" id="partida" class="form-control validate[required,maxSize[<?=$lim_partida?>]]" placeholder="Partida" value="<?=$cliente->part?>" readonly>
                </div>  
            </div>
            <div class="form-group"> 
                ...
                <div class="conboton-r">
                   <? $cont_m=0;$cont_mail=1;
                    foreach (getClienteContacto($cliente->id_info, 'e', 'c') as $mail_cliente){?>
                        ...
                        <div class="<?=$cont_m>0?'col-xs-11 col-md-7 margen-top-d email_'.$cont_m.'col-xs-12 col-md-8':'col-md-8';?>">
                ...
                <div class="conboton-r">
                   <? 
                     ...
                     foreach (getClienteContacto($cliente->id_info, 'c', 'c') as $cel_cliente){?>
                        ...
                        <div class="<?=$cont_c>0?'col-xs-11 col-md-7 margen-top-d cel_'.$cont_c.'col-xs-12 col-md-8':'col-md-8';?>">
            ...
            <div class="form-group">                    
                <div class="conboton-l">
                    ...
                    <div class="col-xs-12 col-md-8">
                        <input type="text" name="poder" id="poder" class="form-control validate[maxSize[<?=$lim_poder?>]]" placeholder="Nro. Poder" value="<?=$cliente->poder?>">
                    </div>
                    <div class="col-xs-12">
                        <button type="button" class="btn btn-warning btn-md col-xs-12 col-md-3 pull-right adjunta"><i class="fa fa-paperclip"></i> Adjuntar</button>
        ...
        <div class="box-footer">
            <button type="submit" class="btn btn-success pull-right col-xs-12 col-md-2"><em class="fa fa-refresh"></em> Actualizar Datos</button>
