...
->setTitle("Saldo de Cuentas a la Fecha")
->setSubject("Saldo de Cuentas a la Fecha")
->setDescription("")
->setKeywords("Excel Office 2007 openxml php")
->setCategory("Saldo de Cuentas a la Fecha");
...
->setCellValue('A1', 'SALDO DE CUENTAS A LA FECHA');
...
$objPHPExcel->getActiveSheet()->setTitle('SaldodeCuentas');
// Establecer la hoja activa, para que cuando se abra el documento se muestre primero.
$objPHPExcel->setActiveSheetIndex(0);

// Se modifican los encabezados del HTTP para indicar que se envia un archivo de Excel.
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="Saldo de Cuentas a la Fecha.xlsx"');
