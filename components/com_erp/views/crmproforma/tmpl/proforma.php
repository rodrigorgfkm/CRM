            ...
            <tfoot>
              ...
              <tr>
                <td colspan="6" style="text-align:center">
                  <a class="btn btn-success col-xs-4" rel="shadowbox; width=950" id="imprime" style="font-size:14px" href="index.php?option=com_erp&view=crmproforma&layout=imprime&id=<?=JRequest::getVar('id', '', 'get')?>&tmpl=component"><em class="fa fa-print"></em> Imprimir</a>
