...
$plantilla = str_replace('{empresa_logo}', '<img  src="media/com_erp/'.$empresa->logo.'" style="height: 126px; position: absolute;top: 36px;left: 28px;>', $plantilla); 
...
$plantilla = str_replace('{cliente_fecha}', fecha($p->fecha), $plantilla);
