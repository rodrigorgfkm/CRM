...
function cambiaGestion(){
	...
	location.href = 'index.php?option=com_erp&view=contaadmcuentas&id='+id+'&tmpl=component';
	}
</script>
<style>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <a class="btn btn-success" onClick="envia('<?=$cta->id?>', '<?=$cta->nombre?>', '<?=$cta->codigo?>', '<?=$id[1]?>')">
