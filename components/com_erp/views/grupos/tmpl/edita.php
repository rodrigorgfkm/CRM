...
<div class="row">
  <section class="col-lg-12">
            ...
            <form method="post" enctype="multipart/form-data" name="form" id="form">              
               <div class="form-group">
                   ...
                   <div class="col-xs-12 col-sm-10">
                       <input type="text" name="grupo" id="grupo" class="form-control validate[required]" value="<?=$grupo->grupo?>">
                   </div>
               </div>
               <div class="form-group">
                   <label for="" class="col-xs-12 col-sm-2">
               ...
               <div class="col-xs-12 col-sm-offset-2">
                   <a href="index.php?option=com_erp&view=grupos" class="btn btn-primary btn-sm col-xs-6 col-sm-3"><i class="fa fa-arrow-left"></i> Regresar</a>
    ...
    <? }else{
        ...
        <p><a href="index.php?option=com_erp&view=grupos" class="btn btn-success btn-sm col-xs-6 col-sm-3"><i class="fa fa-arrow-left"></i> Regresar</a></p>
		<?
		}?>
      </div>
    </div>
