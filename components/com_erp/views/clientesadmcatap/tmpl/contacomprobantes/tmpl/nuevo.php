...
function adicionaDetalle(){
	...
	fila+= '<td><input name="debe[]" type="number" step="any" class="form-control validate[required] text-right" id="debe_'+n+'" onkeyup="monto(this.id)" onBlur="decimal(this.id)" value="0.00"></td>';
	fila+= '<td><input name="haber[]" type="number" step="any" class="form-control validate[required] text-right" id="haber_'+n+'" onkeyup="monto(this.id)" onBlur="decimal(this.id)" value="0.00"></td>';
                ...
                <table class="table table-striped sortable" id="tabla_detalle">
                    ...
                    <tbody>
                      <tr id="tr_0">
                        ...
                        <td id="td_0">
                        	<div class="input-group">
                            	<input name="codigo[]" type="text" class="form-control validate[required]" id="codigo_0" onKeyUp="buscaCodigo(this.id)">
                        ...
                        <td><input name="debe[]" type="number" step="any" class="form-control validate[required] text-right" id="debe_0" onkeyup="monto(this.id)" onBlur="decimal(this.id)" value="0.00"></td>
                        <td><input name="haber[]" type="number" step="any" class="form-control validate[required] text-right" id="haber_0" onkeyup="monto(this.id)" onBlur="decimal(this.id)" value="0.00"></td>
                      ...
                      <tr id="tr_1">
                        ...
                        <td id="td_1">
                        	<div class="input-group">
                            	<input name="codigo[]" type="text" class="form-control validate[required]" id="codigo_1" onKeyUp="buscaCodigo(this.id)">
                                <div class="input-group-btn">
                        ...
                        <td><input name="debe[]" type="number" class="form-control validate[required] text-right" id="debe_1" onKeyUp="monto(this.id)" onBlur="decimal(this.id)" value="0.00"></td>
                        <td><input name="haber[]" type="number" class="form-control validate[required] text-right" id="haber_1" onKeyUp="monto(this.id)" onBlur="decimal(this.id)" value="0.00"></td>
