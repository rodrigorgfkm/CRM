        ...
        <div class="text-right">          
                ...
                <form action="" method="post" name="form" id="form" enctype="multipart/form-data" class="form-horizontal">
                	<div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-2">
                        	<button class="btn btn-info" type="submit" style="display:inline-block">Cargar</button>
                            <a href="index.php?option=com_erp&view=contareportes&layout=balance" class="btn btn-warning" style="display:inline-block"> Limpiar</a>
                        </div>
                    </div>
                  </form>
              </div>
              <div class="col-xs-12">
                <form action="components/com_erp/views/contareportes/tmpl/exporta_balance.php" method="post" id="form_excel">
                  <a href="index.php?option=com_erp&view=contareportes&layout=imprime_balance&gestion=<?=$gestion?>&fecha=<?=$fecha?>&tmpl=component" rel="shadowbox; width=950" class="btn btn-info">
