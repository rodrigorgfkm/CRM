    ...
    <div class="box box-success">
      ...
      <form method="post" name="form" id="form" class="form-horizontal" role="form">
         ...
         <div class="form-group">
             ...
             <div class="col-xs-12 col-sm-10">
                 <input name="nombre" type="text" class="form-control validate[required, maxSize[<?=$lim_nom?>]]" id="focusedInput">
         ...
         <div class="form-group">
             ...
             <div class="col-xs-12 col-sm-10">
                <div class="input-group">
                  ...
                  <input type="text" name="codigo" id="codigo" class="form-control validate[required, maxSize[<?=$lim_cod?>]]" value="<?=getCNTcuentacod()?>">
                </div>
        ...
        <div class="box-footer">
          ...
          <button type="submit" class="btn btn-success pull-right"><em class="fa fa-floppy-o"></em> Crear Cuenta</button>
        </div>
    </form>
    <?php }else{
        $val = newCNTcuenta();
