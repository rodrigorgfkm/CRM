  ...
  <section class="col-lg-12">
    <div class="box box-success">
      <div class="box-header">
		...
		<!-- Título de la vista -->
        <h3 class="box-title">Edita Gestión</h3
      ></div>
      <div class="box-body">
        <? $lim_ges = 4?>
        <? if(!$_POST){?>        
        <form method="post" enctype="multipart/form-data" name="form" id="form" class="form-horizontal">
          <div class="form-group">
               ...
               <div class="col-xs-12 col-sm-9">
                   <input type="text" name="gestion" class="form-control validate[required, maxSize[<?=$lim_ges?>]]" id="gestion" value="<?=$gestion->gestion?>">
               </div>
           </div>
       ...
       <? }else{
            editGestion();?>
            <h3>La gestión fue editada correctamente</h3>
