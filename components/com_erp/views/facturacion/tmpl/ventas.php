        ...
        <div class="row filtros-tablas">
          <div class="col-md-8">
              <form action="" method="post" style="width:100%;">                
                ...
                <div class="junto">
                    Desde
                    <input type="text" disabled id="fecha_ini" class="form-control datepicker" name="fecha_ini" value="<?=JRequest::getVar('fecha_ini', '', 'post')?>">
                    ...
                    <button class="btn btn-info" type="submit" style="margin-left:10px;">Filtrar</button>
          ...
          <div class="col-md-4">
            <form action="components/com_erp/views/facturacion/tmpl/exportar_ventas.php" id="export" method="post">
              <a  data-toggle="modal" data-target=".borratiposoc" href="#excel" class="btn btn-success pull-right xcel">Exportar a Excel</a>
