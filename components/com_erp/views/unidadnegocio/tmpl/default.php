...
<div class="row">
  <section class="col-lg-12">
    <div class="box box-success">
      ...
      <div class="col-xs-12">
          <a href="index.php?option=com_erp&view=unidadnegocio&layout=nuevo" class="btn btn-primary pull-right" style="margin-bottom:5px"><i class="fa fa-plus"></i> Crear Unidad de Negocio</a>
      </div>
      <div class="box-body">
            <table class="table datatable">
                ...
                <tbody>
                   <? foreach (getUnidadesDeNegocio(true)  as $unidad){?>
                    <tr>
                        <td><?=$unidad->unidad_negocio?></td>                        
                        <td>
                            <a href="index.php?option=com_erp&view=unidadnegocio&layout=edita&id=<?=$unidad->id?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                            <button type="button" class="btn btn-danger eliminar" data-toggle="modal" data-target=".borratiposoc" data-id="<?=$unidad->id?>"><i class="fa fa-trash"></i></button>
                        </td>
                    </tr>
                    <? }?>
                </tbody>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel">¿Eliminar Ésta Unidad de Negocio?</h4>
                      ...
                      <div class="modal-body">
                          <form action="" name="form" id="form" class="form-horizontal col-xs-12" role="form" method="get">
                            <div class="col-xs-12 text-right">
                                ...
                                <input type="hidden" name="view" value="unidadnegocio">
