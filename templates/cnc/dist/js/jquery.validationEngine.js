	...
	var methods = {
		...
		*/
		detach: function() {
			...
			if (options.autoPositionUpdate)
				jQuery(window).off("resize", methods.updatePromptsPosition);
					...
					if (errorFound && first_err==null)
						if (field.is(":hidden") && options.prettySelect)
							...
							if(field.data('jqv-prompt-at') instanceof jQuery ){
								...
								field = jQuery(field.data('jqv-prompt-at'));
							}
							first_err=field;
						}
		...
		*/
		_past: function(form, field, rules, i, options) {
			...
			var p=rules[i + 1];
			var fieldAlt = jQuery(form.find("*[name='" + p.replace(/^#+/, '') + "']"));
			var pdate;
		...
		*/
		_getPrompt: function(field) {
			...
			var className = methods._getClassName(field.attr("id")) + "formError";
				var match = jQuery("." + methods._escapeExpression(className) + '.parentForm' + methods._getClassName(formId))[0];
			if (match)
			return jQuery(match);
		},
		/**
